...
typedef struct passinfo
{
	...
	char **cmd_buf; /* Pointer to the command buffer used for memory management in the ';' chain */
	int cmd_buf_type; /* Definition of CMD_type: Specifies the type of command (||, &&, ;) */
	int readfd;
	int histcount;
} info_t;
